...
const seatProducts = ['Ibiza', 'Arona', 'Leon'];
...
function buildProductRow(brand, products) {
  ...
  return '<div style="margin-bottom:' + marginBottom + ';">' +
    '<span style="color:' + brandColour + ';font-weight:bold;">&#x258C;' + brand + '</span>' +
...
function buildSignature(logoSource) {
  ...
  const phoneRow = phone
    ? '<div style="margin-bottom:0;"><span style="font-weight:bold;">M</span>&nbsp;&nbsp;' + escapeHtml(phone) + '</div>'
    : '';

  return '<table role="presentation" style="color:#1d1d1b;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4;border-collapse:collapse;" border="0" cellspacing="0" cellpadding="0">' +
    '<tbody><tr><td style="padding:0;">' +
    '<div style="font-size:22px;font-weight:bold;color:#1d1d1b;">' + escapeHtml(name) + '</div>' +
    '<div style="font-size:14px;color:#666666;margin-bottom:12px;">' + escapeHtml(jobTitle) + '</div>' +
    ...
    '<div style="margin:0 0 9px 0;"><img src="' + logoSource + '" width="244" height="95" alt="CUPRA and SEAT" style="display:block;width:244px;height:95px;border:0;outline:none;text-decoration:none;"></div>' +
    '<div style="font-weight:bold;color:#1d1d1b;margin-bottom:0;">CUPRA & SEAT UK</div>' +
    '<div style="color:#666666;">Yeomans Drive, Blakelands, Milton Keynes MK14 5AN</div>' +
